...
document.getElementById('login-form').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            // Guardamos el objeto completo 'user' (contiene id, username, name, role)
            // Esto es lo que el carrito.js necesita para no redirigirte
            localStorage.setItem('user', JSON.stringify(data.user)); 

            // Opcional: mantenemos estas para compatibilidad con otros scripts viejos
